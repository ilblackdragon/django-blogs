...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.icon'
        db.add_column('blog_blog', 'icon', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blog.icon'
        db.delete_column('blog_blog', 'icon')
