...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'rating_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Post.rating'
        db.alter_column('blog_post', 'rating_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True, to=orm['voter.Rating']))

        # Adding unique constraint on 'Post', fields ['rating']
        db.create_unique('blog_post', ['rating_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Post', fields ['rating']
        db.delete_unique('blog_post', ['rating_id'])

        # Deleting field 'Post.rating_score'
        db.delete_column('blog_post', 'rating_score')

        # Changing field 'Post.rating'
        db.alter_column('blog_post', 'rating_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['voter.Rating']))
    ...
    models = {
        ...
        'blog.post': {
            ...
            'rating': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'post_list'", 'unique': 'True', 'to': "orm['voter.Rating']"}),
