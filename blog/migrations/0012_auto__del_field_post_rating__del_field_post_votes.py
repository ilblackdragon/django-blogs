...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('blog_post', 'rating')

        # Deleting field 'Post.votes'
        db.delete_column('blog_post', 'votes')


    def backwards(self, orm):
        
        # Adding field 'Post.rating'
        db.add_column('blog_post', 'rating', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Post.votes'
        db.add_column('blog_post', 'votes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
