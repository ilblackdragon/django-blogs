...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'votes', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'blog.post': {
            ...
            'votes': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
